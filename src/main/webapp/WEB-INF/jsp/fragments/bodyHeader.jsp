    ...
    <div class="navbar-inner">
        <ul class="nav">
            <li style="width: 100px;"><a href="<spring:url value="/" htmlEscape="true" />"><i class="icon-home"></i>
                Home</a></li>
            <li style="width: 130px;"><a href="<spring:url value="/devopsers/find.html" htmlEscape="true" />"><i
                    class="icon-search"></i> Find devopsers</a></li>
            <li style="width: 140px;"><a href="<spring:url value="/devopsers.html" htmlEscape="true" />"><i
                    class="icon-th-list"></i> Devopsers</a></li>
